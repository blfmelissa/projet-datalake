...
# Dossiers cibles
path_linkedin_emp = "C:/TD_DATALAKE/DATALAKE/1_LANDING_ZONE/LINKEDIN/EMP"
path_glassdoor_avi = "C:/TD_DATALAKE/DATALAKE/1_LANDING_ZONE/GLASSDOOR/AVI"
path_glassdoor_soc = "C:/TD_DATALAKE/DATALAKE/1_LANDING_ZONE/GLASSDOOR/SOC"


meta_path = "C:/TD_DATALAKE/DATALAKE/99_METADATA"
...
for myFileName in myListOfFileSourceTmp:
    ...
    rows.append([str(cle_unique), "taille_du_fichier_html", str(os.path.getsize(src_file))])
